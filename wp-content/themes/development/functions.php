...
function development_setup() {
	 ...
	 * If you're building a theme based on Development, use a find and replace
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'development' ),
	) );
...
function development_scripts() {
	...
	wp_enqueue_script( 'development-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'development-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
